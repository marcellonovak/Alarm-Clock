...
void loop() {
  ...
  String firstRow = "NOT STAND-ALONE", secondRow;
  ...
  switch (displayState) 
  {
    case CLOCK: 
    {
      secondRow = "Time> " + WithLeadingZeros(currentTime.hour()) + ":" + WithLeadingZeros(currentTime.minute()) + ":" + WithLeadingZeros(currentTime.second());
    }
    break;
    ...
    case DATE: 
    {
      secondRow = "Date> " + WithLeadingZeros(currentTime.month()) + " - " + WithLeadingZeros(currentTime.day());
    }
    break;

    case YEAR: 
    {
      secondRow = "Year> " + String(currentTime.year());
    }
    break;
  }
